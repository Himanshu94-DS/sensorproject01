...
class ModelTrainer:
    ...
    def evaluate_mode(self,x,y,models):
        try:
    ...
    def get_best_model(self,
        ...
        try:
            ...
            model_report:dict = self.evaluate_mode(x_train=x_train,
                                                   y_train=y_train,
                                                   x_test=x_test,
                                                   y_test=y_test,
                                                   models = self.models)
    ...
    def initiate_model_trainer(self,train_array, test_array):
        ...
        try:
            ...
            model_report : dict = self.evaluate_mode(x=x_train, y=y_train, models=self.models)
            ...
            best_model = self.finetune_best_model(best_moel_name=best_model_name,
            ...
            logging.info(f"Best found on both training and testing datset")
